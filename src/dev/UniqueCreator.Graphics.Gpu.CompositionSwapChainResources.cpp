...
#include "cmd/ComputeCommandContext.h"
...
namespace winrt::UniqueCreator::Graphics::Gpu::implementation
{
    ...
    IGraphicsComputeCommandContext CompositionSwapChainResources::CreateGraphicsComputeCommandContext()
    {
        return make<DirectGpuCommandContext>(uc::gx::dx12::create_graphics_compute_command_context(m_direct_context_allocator.get()));
    }

    IComputeCommandContext CompositionSwapChainResources::CreateComputeCommandContext()
    {
        return make<ComputeCommandContext>(uc::gx::dx12::create_compute_command_context(m_direct_context_allocator.get()));
    }

	IGraphicsCommandContext CompositionSwapChainResources::CreateGraphicsCommandContext()
	{
